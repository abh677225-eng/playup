              ...
              <>
                ...
                <div style={{ flex: 1, overflowY: "auto", padding: "1.5rem", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                  {loadingMessages ? (
                    ...
                    return (
                      <div key={msg.id} className="msg-bubble" style={{ display: "flex", flexDirection: "column", alignItems: isMe ? "flex-end" : "flex-start" }}>
                        {/* Sender name + timestamp */}
                        <div style={{ display: "flex", alignItems: "center", gap: "0.4rem", marginBottom: "0.25rem", flexDirection: isMe ? "row-reverse" : "row" }}>
                          <span style={{ fontSize: "0.75rem", fontWeight: 700, color: isMe ? "#1e3a5f" : "#84CC16" }}>{senderName}</span>
                          <span style={{ fontSize: "0.7rem", color: "#94a3b8" }}>{formatTime(msg.created_at)}</span>
                        </div>
                        {/* Bubble */}
